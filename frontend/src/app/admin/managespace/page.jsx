            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-2" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-3" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-4" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-5" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-6" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-7" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-8" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-9" />
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="size-px whitespace-nowrap px-6 py-3">
                    <div className="inline-block">
                      <div id="hs-sparklines-line-chart-10" />
                    </div>
                  </td>
                </tr>
              </tbody>
